...
, (N'U00006', 1, 0, N'Employee, @1, National ID already exists - defaulting to 99999. National ID ID is: @2.', N' ', N' ', 0, N'0', 0, 0)
, (N'U00007', 1, 0, N'National ID was blank for employee, @1 - defaulting to ''99999''.', N' ', N' ', 0, N'0', 0, 0)
...
, (N'U00012', 1, 0, N'Employee, @1, does not exist.', N' ', N' ', 0, N'0', 0, 0)
...
, (N'U00039', 1, 0, N'Employer ID, @1, does not exist - bypassing record.', N' ', N' ', 0, N'0', 0, 0)
...
, (N'U00046', 1, 0, N'National ID is blank - defaulting to ''99999'' for employee, @1.', N' ', N' ', 0, N'0', 0, 0)
...
, (N'U00100', 1, 0, N'WARNING: Invalid Employment Type code, @1, for employee @2.', N'', N'', 0, N'0', 0, 0)
, (N'U00101', 1, 0, N'Invalid pay element amount, @1, for employee, @2, and pay element id, @3.', N'', N'', 0, N'0', 0, 0)
, (N'U00102', 1, 0, N'Invalid date value from HCM, ''@1'', for employee, @2, and event id, @3.', N'', N'', 0, N'0', 0, 0)
, (N'U00103', 1, 0, N'Pay element id, @1, for employee, @2, is not a valid pay element in the system.', N'', N'', 0, N'0', 0, 0)

, (N'U00104', 1, 0, N'<PAY GROUP SECTION (8)>', N'', N'', 0, N'0', 0, 0)
, (N'U00105', 1, 0, N'Total Pay Group Changes: @1', N'', N'', 0, N'0', 0, 0)
, (N'U00106', 1, 0, N'New pay group, (@1) is same as current pay group, for employee @2 - bypassing record.', N'', N'', 0, N'0', 0, 0)

, (N'U00107', 1, 0, N'<LABOR GROUP SECTION (9)>', N'', N'', 0, N'0', 0, 0)
, (N'U00108', 1, 0, N'Total Labor Group Changes: @1', N'', N'', 0, N'0', 0, 0)
, (N'U00109', 1, 0, N'New labor group, (@1) is same as current labor group, for employee @2 - bypassing record.', N'', N'', 0, N'0', 0, 0)
, (N'U00110', 1, 0, N'New labor group is blank, for employee @2 - bypassing record.', N'', N'', 0, N'0', 0, 0)
, (N'U00111', 1, 0, N'Invalid Labor Group Code, (@1), for employee, @2 - bypassing record.', N' ', N' ', 0, N'0', 0, 0)

, (N'U00115', 1, 0, N'<POSITION TITLE SECTION (10)>', N'', N'', 0, N'0', 0, 0)
...
, (N'U00119', 1, 0, N'@1 update, employee @1: New hire, transfer, or rehire status change event is present in this extract. Bypassing record since update would have occurred in one of those events.', N'', N'', 0, N'0', 0, 0)
